...
public class TimerArcContent implements TransformableContent
{
   ...
   *          radius
   */
  public TimerArcContent(final int radius)
  {
    this.radius = radius;
    this.percent = 1.0;
  }
  ...
  @Override
  public void render(final Graphics gRaw)
  {
  ...
  @Override
  public Rectangle2D getBounds2D(final boolean absolute)
  {
    return new Rectangle2D.Double(x, y, radius * scaleX, radius * scaleY);
  }

  @Override
  public void setLocation(final double newX, final double newY)
  {
    this.x = newX;
    this.y = newY;
  }
  ...
  @Override
  public void setRotation(final double r, final double cx, final double cy)
  {
  }
