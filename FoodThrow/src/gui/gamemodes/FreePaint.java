...
public class FreePaint extends PaintWall
{
   ...
   * @throws IOException
   */
  public FreePaint(final int width, final int height, final FoodSelector selector)
      throws IOException
  {
  ...
  public void saveFile()
  {
    try
    {
      ...
      // Show confirmation
      javax.swing.JOptionPane.showMessageDialog(null, "Saved painting as:\n" + file.getName(),
    ...
    {
      e.printStackTrace();
      javax.swing.JOptionPane.showMessageDialog(null, "An error occurred while saving the image.",
